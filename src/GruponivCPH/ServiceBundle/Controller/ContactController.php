...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ServiceBundle:Contact')->findAll();
        
        $aaData = array();
        foreach ($entities as $ent) {
            $delete_form = $this->createDeleteForm($ent->getId())->createView();
            $action = $this->renderView('ServiceBundle:Contact:actions.html.twig', array('delete_form' => $delete_form, 'entity_id' => $ent->getId(), 'entity_name' => ''));
        ...
        return $this->render('ServiceBundle:Contact:index.html.twig', array(
            'entities' => $entities,
            'aaData' => $aaData
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ServiceBundle:Contact:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ServiceBundle:Contact')->find($id);
        ...
        return $this->render('ServiceBundle:Contact:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ServiceBundle:Contact:edit.html.twig', array(
            'entity'      => $entity,
